        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AadhaarImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    DrivingLicenseImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    KycStatus = table.Column<int>(type: "int", nullable: false),
                    RegistrationDate = table.Column<DateOnly>(type: "date", nullable: false),
                    IsAadhaarUploaded = table.Column<bool>(type: "bit", nullable: false),
                    IsDrivingLicenseUploaded = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableUpto = table.Column<DateTime>(type: "datetime2", nullable: false),
